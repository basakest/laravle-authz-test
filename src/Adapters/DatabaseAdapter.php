...
use Lauthz\Contracts\FilteredDatabaseAdapter as FilteredDatabaseAdapter;
 ...
 */
class DatabaseAdapter implements DatabaseAdapterContract, BatchDatabaseAdapterContract, UpdatableDatabaseAdapterContract, FilteredDatabaseAdapter
{
    use AdapterHelper;
